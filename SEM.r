...
#SEM model for facmcom motif within eukaryotes
sem.model4 <- psem (
lm(biodiversity ~ fragility+ facmcom_euk + modularity +Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C,  data = data),
lm(fragility~ facmcom_euk + modularity +Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C, data = data),
lm(modularity~  facmcom_euk +Distance_from_equator+Elevation+TSEA +MAP  +pH+Texture+Soil_C ,data = data),
lm(facmcom_euk~  Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C, data = data),
lm(pH~ Distance_from_equator+Elevation+TSEA+MAP , data = data),
lm(Soil_C~ Distance_from_equator+Elevation+TSEA+MAP+pH +Texture  , data = data),
lm(Texture~ Distance_from_equator+Elevation+TSEA+MAP , data = data),
lm(TSEA~ Distance_from_equator+Elevation, data = data),
...
#SEM model for cycfac motif across domains
sem.model5 <- psem (
lm(biodiversity ~ fragility+ cycfac_across + modularity +Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C,  data = data),
lm(fragility~ cycfac_across + modularity +Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C, data = data),
lm(modularity~  cycfac_across +Distance_from_equator+Elevation+TSEA +MAP  +pH+Texture+Soil_C ,data = data),
lm(cycfac_across~  Distance_from_equator+Elevation+TSEA+MAP+pH+Texture+Soil_C, data = data),
lm(pH~ Distance_from_equator+Elevation+TSEA+MAP , data = data),
lm(Soil_C~ Distance_from_equator+Elevation+TSEA+MAP+pH +Texture  , data = data),
lm(Texture~ Distance_from_equator+Elevation+TSEA+MAP , data = data),
lm(TSEA~ Distance_from_equator+Elevation, data = data),
